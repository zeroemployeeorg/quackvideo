---
name: quackvideo
description: Run the QuackVideo creator flywheel from Cursor. Use when ingesting recordings, transcribing, ranking clips, reviewing moments, composing captions, or packaging platform-ready social/podcast/tutorial assets.
---
